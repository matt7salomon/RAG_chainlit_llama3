...
from langchain_community.embeddings import AzureOpenAIEmbeddings, OpenAIEmbeddings, OllamaEmbeddings
...
chat_completion_deployment ='llama3-8b-8192' # "gpt-3.5-turbo-0125"  # ,os.getenv("AZURE_OPENAI_DEPLOYMENT")
embeddings_deployment = 'llama3' #"text-embedding-3-large"  # ,os.getenv("AZURE_OPENAI_ADA_DEPLOYMENT")
...
async def start():
    ...
    if api_type == "azure":
        ...
        llm = ChatGroq(model_name=chat_completion_deployment, groq_api_key=groq_api_key)
